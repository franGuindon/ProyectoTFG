...
% New little license, perhaps I should ask possible legitimate contracts
%
% Engineering project idea:
% Can AI build little predictors for psychometric measures?
% We may build little auto psychometricians ...
% 
% I currently percieve myself to be building a bridge between a simple
% statistical measure and another seemingly unrelated one at some higher level
% of abstraction. (fancy way of saying means and vars of mb borders as simple
% stat)
%
% And another,
%
...
% TODO TFG:
% Falta analisis de balance
% ¿Cómo cambia precision y recall con balance?
% Gráfica Balance vs Precision
% Gráfica Balance vs Recall
%
% Falta elemento gstreamer
% - Start by replicating dT2, with same modelpath, upscale properties
% - Add output enumerator
% - Move upscale property to enumerator
% - 
...
\begin{document}
  ...
  \includepdf[offset=2.3cm -2.5cm]{230616_acta_aprobacion_Francis_Guindon_fPAM_fPMP_fJACG} % Incluir el acta firmada acá.
  ...
  % \includepdf[offset=2.3cm -2.5cm]{230616_acta_evaluacion_Francis_Guindon_fPAM_fPMP_fJACG} % Incluir el acta firmada acá.
